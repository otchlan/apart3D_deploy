    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50">
      <main>
        ...
        <section className="container mx-auto px-4 py-12">
          <h1 className="text-5xl font-bold text-gray-800 mb-6 text-center">Explore Our Apartments</h1>
          <p className="text-xl text-gray-600 mb-8 text-center">Discover your perfect home with our interactive 3D tour and premium apartment options.</p>
        </section>
        ...
        <section className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3">
              {/* Filters */}
              <div className="bg-white rounded-lg shadow-lg p-6 mb-8 top-4">
            ...
            {/* Right Column - 3D View and Featured Apartments */}
            <div className="lg:w-2/3">
              {/* 3D Visualization */}
              <div className="bg-white p-4 rounded-lg shadow-lg mb-8">
                <h2 className="text-3xl font-semibold text-gray-800 mb-4">3D Building Tour</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[1, 2].map((index) => (
                  <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">Featured Apartment {index}</h3>
